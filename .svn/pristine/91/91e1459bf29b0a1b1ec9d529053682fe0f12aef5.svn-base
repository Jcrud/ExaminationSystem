...
function checkForm(form){
	...
	var anwser='${student.answer}';
	if(form.answer.value!=anwser){
		alert("答案错误,请重新输入答案");form.answer.value=="";form.answer.focus();return false;
	}
}
</script>
<body>
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="131" background="${path}/Images/top_bg.jpg">&nbsp;</td>
  </tr>
</table>
    ...
    <td valign="top" bgcolor="#FFFFFF"><table width="774" height="474"  border="0" cellpadding="0" cellspacing="0" align="center">
      <tr>
        <td height="30" bgcolor="#EEEEEE" class="tableBorder_thin"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="word_grey">&nbsp;<img src="${path}/Images/f_ico.gif" width="8" height="8"> 当前位置：→ <span class="word_darkGrey">找回密码 &gt;&gt;&gt;</span></td>
			  <td align="right"><img src="${path}/Images/m_ico1.gif" width="5" height="9">&nbsp;<a href="${path}/index.jsp" >返回首页</a>&nbsp;</td>
              </tr>
          </table></td>
        </tr>
      <tr>
...
<form action="${path}/frontEnd/seekPwd2" method="post" name="studentForm" onsubmit="return checkForm(this)">
  ...
  <table width="57%"  border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#D2E3E6" bordercolorlight="#FFFFFF">
    ...
    <td width="78%" align="left">
	  ...
	  <input type="text" value="${student.question}" size="40" name="seekPwd2" readonly="true"/> <span class="word_orange1"> （只读）</span>	  </td>
    </tr>
    <tr align="center">
    ...
    <tr>
      ...
      <td><input type="submit"  class="btn_grey" value="下一步"/>
        &nbsp;
      ...
      <tr>
        <td height="141" align="right" valign="top"><img src="${path}/Images/seedPwd.gif" width="139" height="153"></td>
      </tr>
    </table>
</td>
  </tr>
