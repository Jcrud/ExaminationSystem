...
<form action="studentDel" method="post" name="studentForm">
&nbsp;
...
<c:forEach items="${students}" var="s"> 	
  <tr>
	...
	<td align="center"><fmt:formatDate value="${s.jointime}" type="date" pattern="yyyy-MM-dd"/></td>
    <td align="center">${s.question}</td>	
    <td align="center">${fn:substring(s.cardno, 0, 7)}***********</td>
    <td align="center"><input name="delIdArray" type="checkbox" value="${s.id}"></td>
  </tr>
</c:forEach> 
</table>
